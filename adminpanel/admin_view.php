        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <h1 class="mt-4">View Employee Profile</h1>
                    ...
                    if (isset($_GET['id'])) {
                        ...
                        $query = "SELECT * FROM admin_db WHERE id='$employee_id' ";
                    ...
                    ?>
                            <form action="/emp/function_facu.php" method="POST" enctype="multipart/form-data">
                                <div class="profile-container">
                                    ...
                                    <div class="photo-container">
                                        <div class="photo-container">
                                            <div class="photo-box">
                                                <?php if ($emp['picture']): ?>
                                                    <img src="<?= $image_src; ?>" alt="Student Photo" class="photo-display" />
                                                <?php else: ?>
                                                    <span class="add-photo-icon">+</span>
                                                <?php endif; ?>
                                            </div>
                                            <span class="add-photo-text">Photo</span>
                                        </div>
                                        ...
                                        <div class="profile-form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" value="<?= $emp['name']; ?>" class="form-input" disabled>
                                            </div>

                                            <div class="form-group">
                                                <label class="form-label">Position</label>
                                                <select class="form-select" name="position" disabled>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-input" value="<?= $emp['birthdate']; ?>" name="birthdate" disabled />
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-input" value="<?= $emp['email']; ?>" name="email" placeholder="Enter Email" disabled />
                                            </div>

                                            <div class="form-group">
                                                <label class="form-label">Contact Number</label>
                                                <input type="text" class="form-input" value="<?= $emp['contact_num']; ?>" name="contact" placeholder="Enter Contact Number" disabled />
                                            </div>

                                            <div class="form-group">
                                                <label class="form-label">Full Address</label>
                                                <input type="text" class="form-input" value="<?= $emp['address']; ?>" name="address" placeholder="Enter Address" disabled />
                                            </div>
                                        </div>
                                    </div>
                            </form>
